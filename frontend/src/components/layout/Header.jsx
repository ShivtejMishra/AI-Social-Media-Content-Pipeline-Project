  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between px-4 sm:px-6 py-4 bg-slate-50 dark:bg-slate-950/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          onClick={toggleTheme}
          className="p-2 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white transition-all duration-200"
        ...
        <div onClick={() => navigate('/app/settings')} className="cursor-pointer hover:ring-indigo-500/50 transition-all rounded-full">
